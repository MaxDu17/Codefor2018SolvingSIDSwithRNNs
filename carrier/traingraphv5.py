...
with tf.Session() as sess:
    log_loss = open("GraphV5/GRAPHS/LOSS.csv", "w")
    ...
    tf.train.write_graph(sess.graph_def, 'GraphV5/GRAPHS/', 'graph.pbtxt')
    writer = tf.summary.FileWriter("GraphV5/GRAPHS/",sess.graph)
    ...
    for epoch in range(HYP.NUM_EPOCHS):
        ...
        if epoch%500 ==0:
            saver.save(sess, "GraphV5/CHECKPOINTS/GraphV5",global_step = epoch)
