...
with tf.Session() as sess:
    ...
    tf.train.write_graph(sess.graph_def, 'GraphV6/GRAPHS_TRAIN/', 'graph.pbtxt')
    writer = tf.summary.FileWriter("GraphV6/GRAPHS_TRAIN/",sess.graph)
    ...
    for epoch in range(HYP.NUM_EPOCHS):
        ...
        if epoch%500 ==0:
            saver.save(sess, "GraphV6/CHECKPOINTS/GraphV6",global_step = epoch)
